...
public class Cuboid {
    ...
    public static Cuboid createCube(Location location, int sideLength) {
        World world = location.getWorld();
        if (world == null) return null;

        int halfSide = sideLength / 2;

        int xMin = location.getBlockX() - halfSide;
        int yMin = location.getBlockY() - halfSide;
        int zMin = location.getBlockZ() - halfSide;
        int xMax = location.getBlockX() + halfSide;
        int yMax = location.getBlockY() + halfSide;
        int zMax = location.getBlockZ() + halfSide;
